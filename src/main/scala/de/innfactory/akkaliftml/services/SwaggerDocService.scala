package de.innfactory.akkaliftml.services

import akka.actor.ActorSystem
import akka.stream.ActorMaterializer
import com.github.swagger.akka._
import com.github.swagger.akka.model.Info
import de.innfactory.akkaliftml.http.routes.{AlsServiceRoute, AuthServiceRoute}
...
class SwaggerDocService(address: String, port: Int, system: ActorSystem)
  ...
  override val apiTypes = Seq(
    ru.typeOf[AuthServiceRoute], ru.typeOf[AlsServiceRoute]
  )
